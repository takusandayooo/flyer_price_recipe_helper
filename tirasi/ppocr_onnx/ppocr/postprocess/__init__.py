...
from .rec_postprocess import (ABINetLabelDecode, AttnLabelDecode,
                              CANLabelDecode, CTCLabelDecode,
                              DistillationCTCLabelDecode, NRTRLabelDecode,
                              PRENLabelDecode, RFLLabelDecode, SARLabelDecode,
                              SEEDLabelDecode, SPINLabelDecode, SRNLabelDecode,
                              ViTSTRLabelDecode, VLLabelDecode)
from .sast_postprocess import SASTPostProcess
from .table_postprocess import TableLabelDecode, TableMasterLabelDecode
from .vqa_token_re_layoutlm_postprocess import (DistillationRePostProcess,
                                                VQAReTokenLayoutLMPostProcess)
from .vqa_token_ser_layoutlm_postprocess import (
    DistillationSerPostProcess, VQASerTokenLayoutLMPostProcess)
